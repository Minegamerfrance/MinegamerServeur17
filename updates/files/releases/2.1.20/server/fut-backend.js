...
// player on the client (Effenberg -> EVANGELISTA, MatthÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤us -> BLACKMAN), and
...
const V38_REMOVED_ICON_ASSET_IDS = new Set([
  ...
  191190, // broken MatthÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤us slot -> Blackman
...
const V38_REMOVED_ICON_RESOURCE_IDS = new Set([
  ...
  16992775,16968406, // broken Effenberg / MatthÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¤us resources
...
const RIBERY_SPECIAL_CARD = {
  assetId:156616,
  name:'Franck RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry',
  displayName:'Franck RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry', commonName:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry', knownAs:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry', firstName:'Franck', lastName:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry', surname:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry', shortName:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry',
  rating:90,
  position:'LM',
  positionId:16,
  teamId:21,
...
const KAKA_SPECIAL_CARD = {
  assetId:138449,
  name:'KakÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡',
  displayName:'KakÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡', commonName:'KakÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡', knownAs:'KakÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡', firstName:'Ricardo', lastName:'KakÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡', surname:'KakÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡', shortName:'KakÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡',
  rating:89,
  position:'CAM',
  positionId:18,
  teamId:47,
...
const COMMUNITY_SBC_CARDS = [
  ...
  {setId:96006,challengeId:960061,assetId:150418,resourceId:100813714,name:'Mario GÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³mez',shortName:'Gomez',rating:88,position:'ST',positionId:25,teamId:21,leagueId:19,nation:21,attributes:[83,90,73,82,43,83],skillMoves:3,weakFoot:4,requiredRating:84},
  ...
  {assetId:190048,resourceId:100853344,name:'Gerd MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼ller',shortName:'MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼ller',rating:92,position:'ST',positionId:25,teamId:ICON_CLUB_ID,leagueId:ICON_LEAGUE_ID,nation:21,attributes:[87,92,76,85,44,74],skillMoves:4,weakFoot:4,preferredFoot:'right',icon:true},
  {assetId:261593,resourceId:17038809,name:'JÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼rgen Kohler',shortName:'Kohler',rating:89,position:'CB',positionId:5,teamId:ICON_CLUB_ID,leagueId:ICON_LEAGUE_ID,nation:21,attributes:[71,51,63,62,91,90],skillMoves:2,weakFoot:3,preferredFoot:'right',icon:true},
...
const DANI_ALVES_SBC_REQUIREMENTS = [
  {type:'NATION_COUNT',scope:'SQUAD',nationId:54,min:2,value:2,name:'Joueurs brÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©siliens : minimum 2'},
  ...
  {type:'TEAM_RATING',scope:'SQUAD',min:83,value:83,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 83'},
  {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:70,value:70,name:'Collectif : minimum 70'},
  {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,exact:true,name:"Nombre de joueurs dans l'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : 11"}
];
...
const DRAFT_OPPONENT_TEAMS = [
  ...
  {teamId:21,teamName:'FC Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen',teamAbbr:'FCB'},
...
const PRESENTATION_ITEMS = [
  ...
  {id:1700000001,resourceId:6300005,assetId:14,teamid:21,teamId:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:2,displayName:'Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen Home',defaultActiveState:'activeHomeKit',itemState:'activeHomeKit'},
  {id:1700000002,resourceId:6400004,assetId:15,teamid:21,teamId:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:3,displayName:'Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen Away',defaultActiveState:'activeAwayKit',itemState:'activeAwayKit'},
  {id:1700000003,resourceId:6000004,assetId:21,teamid:21,teamId:21,cardassetid:39,cardsubtypeid:11,itemType:'custom',family:'badges',table:'fcc_badgecards',rating:87,rareflag:1,category:1,displayName:'Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen',defaultActiveState:'activeBadge',itemState:'activeBadge'},
...
function loadFifa17ManagerCatalogue() {
  ...
  try {
    ...
    return [
      {managerId:89,staffId:89,pictureId:89,cardDbId:1000089,assetId:1000089,resourceId:1000089,definitionId:1000089,headId:232298,headAssetId:232298,firstName:'ArsÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨ne',lastName:'Wenger',name:'ArsÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨ne Wenger',rating:86,value:86,rareflag:1,rareFlag:1,nation:18,teamid:1,teamId:1,leagueId:13,managerLeagueId:13,formationId:0,formationid:0,talkRating:0,negotiation:3,contractBoost:3,quality:'gold'},
      ...
      {managerId:414,staffId:414,pictureId:414,cardDbId:1000414,assetId:1000414,resourceId:1000414,definitionId:1000414,headId:232302,headAssetId:232302,firstName:'JÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼rgen',lastName:'Klopp',name:'JÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼rgen Klopp',rating:84,value:84,rareflag:1,rareFlag:1,nation:21,teamid:9,teamId:9,leagueId:13,managerLeagueId:13,formationId:0,formationid:0,talkRating:0,negotiation:3,contractBoost:3,quality:'gold'},
...
const CLUB_ITEM_CARDS = [
  {resourceId:6300005,assetId:14,teamid:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:2,displayName:'Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen Home',defaultActiveState:'activeHomeKit'},
  {resourceId:6400004,assetId:15,teamid:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:3,displayName:'Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen Away',defaultActiveState:'activeAwayKit'},
  {resourceId:6000004,assetId:21,teamid:21,cardassetid:39,cardsubtypeid:11,itemType:'custom',family:'badges',table:'fcc_badgecards',rating:87,rareflag:1,category:1,displayName:'Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen',defaultActiveState:'activeBadge'},
...
function loadCatalog() {
  if (!catalog) {
    ...
    if(!catalog.specials.some(card=>Number(card.resourceId)===RIBERY_SBC_RESOURCE_ID))catalog.specials.push({...RIBERY_SBC_CARD,displayName:RIBERY_SBC_CARD.name,commonName:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry',knownAs:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry',firstName:'Franck',lastName:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry',surname:'RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry'});
...
function init(logFunction) {
  ...
  if(cloudProfile){
    ...
    MNG_FULL_SAVE_HYDRATION_PROMISE=hydrateMngFullCloudSave();
  }else{
    MNG_CLOUD_SYNC_ENABLED=false;
...
function saveSquad(body, routeId) {
  ...
  // Return a wire-only document if the client echoes one back instead of polluting Mes ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipes.
...
function rewardPackDocument(entry) {
  ...
  if(Number(entry.rewardResourceId)>0){
    ...
    const rewardName=`RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC - ${playerName}`;
    return {
  ...
  if(PACKS[packId]){
    ...
    return {
      ...
      name:pack.name,nameLoc:pack.name,description:`RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense : ${pack.name}`,descriptionLoc:`RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense : ${pack.name}`,
...
const MNG_SBC_PLAYER_PACK_META_V17 = new Map([
  ...
  [295002,{name:'Philipp Lahm [Loan]', description:'Joueur garanti : Philipp Lahm en prÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªt 10 matchs.'}],
  [296001,{name:'Franck RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry',   description:'Joueur garanti : Franck RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry.'}],
...
async function openRewardPack(instanceId) {
  ...
  if(index<0)return {status:404,error:'REWARD_PACK_NOT_FOUND',reason:'Aucun pack rÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense disponible.'};
  ...
  if(Array.isArray(entry.cloudResourceIds)&&entry.cloudResourceIds.length){
    ...
    if(cards.length!==entry.cloudResourceIds.length)return {status:409,error:'CLOUD_SBC_REWARD_INVALID',reason:'RÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©compense DCE cloud introuvable.'};
  ...
  if(Number(entry.rewardResourceId)>0){
    ...
    if(!card)return {status:409,error:'SBC_PLAYER_REWARD_NOT_FOUND',reason:'Carte de rÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC introuvable.'};
    const item=makePlayerItem(card,state,PILE_PURCHASED,true);
    const loanGames=Math.max(0,Number(entry.loanGames)||0);
    if(loanGames>0){
...
function auroraSbcElgReq(requirements) {
  ...
  for(const req of requirements||[]){
    ...
    if(type==='PLAYER_COUNT'){
      // Le nombre total de joueurs est portÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© par challenge.numPlayers/squadSize.
      // Ne jamais crÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©er un slot elgReq key=2 isolÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©.
      continue;
    }
...
function offlineSeasonOpponentDocument(teamId,gameIndex=0) {
  ...
  const teamName=primaryPool[0]?.teamName||primaryPool[0]?.clubName||`ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°quipe IA ${teamId}`;
  return {
...
const OFFLINE_TOURNAMENT_DEFS = [
  {id:1,name:'Coupe Bronze hors ligne',description:'Remportez quatre matchs ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â  ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©limination directe.',prize:500,trophyResourceId:1500,rounds:[[1,150],[1,200],[2,300],[2,500]]},
  {id:2,name:'Coupe Argent hors ligne',description:'Une coupe relevÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©e rÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©servÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©e au mode solo.',prize:750,trophyResourceId:1501,rounds:[[1,175],[2,250],[2,375],[3,650]]},
  {id:3,name:'Coupe Or hors ligne',description:'Affrontez des ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipes fortes et gagnez la finale.',prize:1000,trophyResourceId:1502,rounds:[[2,225],[2,325],[3,500],[3,850]]},
...
// MNG DRAFT V7 - AURORA NATIVE WIRE
  ...
  const lahmLoanSet={
    ...
    description:'Echangez une equipe pour obtenir Lahm 95 en prÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªt 10 matchs.',repeatable:false,
  ...
  const riberySet={
    ...
    description:'Echangez une equipe pour obtenir Franck RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry 90.',repeatable:false,
  ...
  const terryFinalPackAward={
    ...
    packAssetId:4,packAssetID:'4',name:'RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC - John Terry',nameLoc:'RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC - John Terry',
    localizedName:'RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC - John Terry',packName:'RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC - John Terry',packs:'RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC - John Terry',packsAmount:1,
    AWD_PACKS_STRING:'RÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense SBC - John Terry',AWD_PACKS_AMOUNT:1,AWD_PACKS_ASSET_IDS:'4',
...
if(['/ut/game/fifa17/sbs/sets','/ut/game/fifa17/sbc/sets','/sbs/sets'].includes(urlPath)&&method==='GET')return send(200,{
  ...
  const lahmLoanChallenge={
    ...
    description:'Obtenez Lahm 95 en prÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªt 10 matchs.',formation:'f442',formationId:0,
...
const lahmLoanSbcSquad={
  ...
  const riberyChallengeDefs=[
    {challengeId:960011,id:960011,setId:96001,name:'FC Bayern MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼nchen',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe avec des joueurs du Bayern.',formation:'f442',formationId:0,packId:203,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'TEAM_COUNT',scope:'SQUAD',teamId:21,min:1,value:1,name:'Joueurs du Bayern : minimum 1'},
      {type:'TEAM_RATING',scope:'SQUAD',min:82,value:82,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 82'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:80,value:80,name:'Collectif : minimum 80'}]},
    {challengeId:960012,id:960012,setId:96001,name:'Les Bleus',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe construite autour de joueurs franÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ais.',formation:'f433',formationId:0,packId:204,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'NATION_COUNT',scope:'SQUAD',nationId:18,min:2,value:2,name:'Joueurs franÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ais : minimum 2'},
      {type:'TEAM_RATING',scope:'SQUAD',min:83,value:83,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 83'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:85,value:85,name:'Collectif : minimum 85'}]},
    {challengeId:960013,id:960013,setId:96001,name:'Bundesliga',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe de Bundesliga avec au moins une carte TOTW.',formation:'f4231',formationId:0,packId:303,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'LEAGUE_COUNT',scope:'SQUAD',leagueId:19,min:4,value:4,name:'Joueurs Bundesliga : minimum 4'},
      {type:'SPECIAL_COUNT',scope:'SQUAD',cardType:'totw',min:1,value:1,name:'Joueurs TOTW : minimum 1'},
      {type:'TEAM_RATING',scope:'SQUAD',min:84,value:84,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 84'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:80,value:80,name:'Collectif : minimum 80'}]},
    {challengeId:960014,id:960014,setId:96001,name:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°quipe 85',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe trÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨s bien notÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©e avec un joueur TOTW pour terminer le dÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©fi RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry.',formation:'f41212',formationId:0,packId:304,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'SPECIAL_COUNT',scope:'SQUAD',cardType:'totw',min:1,value:1,name:'Joueurs TOTW : minimum 1'},
      {type:'TEAM_RATING',scope:'SQUAD',min:85,value:85,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 85'},
  ...
  const riberyChallenges=riberyChallengeDefs.map(def=>{
    ...
    const packAward={type:'pack',value:def.packId,halId:0,count:1,assetId:3,packId:def.packId,name:PACKS[def.packId]?.name||'Pack rÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense'};
  ...
  if(match){
    ...
    if(method==='PUT'){
      ...
      if(allDone&&!state.sbcRiberyCompleted&&setCloudReward){
        finalRewardPack={id:Number(state.nextRewardPackId++),packId:296001,source:'SBC_RIBERY_FINAL',setId:96001,playerName:'Franck RibÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©ry',rewardResourceId:RIBERY_SBC_RESOURCE_ID,cloudResourceIds:setCloudReward.resourceIds||[],cloudTransactionId:setCloudReward.transactionId};
  ...
  const terryChallengeDefs=[
    {challengeId:960111,id:960111,setId:96011,name:'Chelsea',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe avec des joueurs de Chelsea.',formation:'f442',formationId:0,packId:304,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'TEAM_COUNT',scope:'SQUAD',teamId:5,min:2,value:2,name:'Joueurs de Chelsea : minimum 2'},
      {type:'TEAM_RATING',scope:'SQUAD',min:82,value:82,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 82'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:80,value:80,name:'Collectif : minimum 80'}]},
    {challengeId:960112,id:960112,setId:96011,name:'Three Lions',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe construite autour de joueurs anglais.',formation:'f433',formationId:0,packId:305,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'NATION_COUNT',scope:'SQUAD',nationId:14,min:4,value:4,name:'Joueurs anglais : minimum 4'},
      {type:'TEAM_RATING',scope:'SQUAD',min:83,value:83,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 83'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:85,value:85,name:'Collectif : minimum 85'}]},
    {challengeId:960113,id:960113,setId:96011,name:'Premier League',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe de Premier League avec au moins une carte TOTW.',formation:'f4231',formationId:0,packId:305,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
    ...
    {challengeId:960114,id:960114,setId:96011,name:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°quipe 85',description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°changez une ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe trÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¨s bien notÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©e pour terminer le Flashback de Terry.',formation:'f41212',formationId:0,packId:308,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'TEAM_RATING',scope:'SQUAD',min:85,value:85,name:'Note ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©quipe : minimum 85'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:70,value:70,name:'Collectif : minimum 70'}]}
  ];
  ...
  if(match){
    ...
    if(method==='PUT'){
      ...
      if(finalRewardPack){
        ...
        response.groupCompleted=true;response.setCompleted=true;response.success=true;response.message='Groupe terminÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© !';
  ...
  const communityChallengeDocuments=COMMUNITY_SBC_DEFS.map(def=>{
    ...
    const challengeAward={
      ...
      packId:challengePackId,name:challengePack?.name||'Pack rÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©compense'
    };
    ...
    const challenge={
      ...
      description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°quipe 83 avec 2 BrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©siliens, 3 joueurs de Serie A, 1 joueur TOTW et collectif minimum 70.',
  ...
  if(match){
    ...
    if(method==='PUT'){
      ...
      return send(200,{
        completed:true,isCompleted:true,groupCompleted:true,setCompleted:true,success:true,message:'Groupe terminÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© !',
  ...
  const benYedderChallenge={
    ...
    description:'ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°quipe 82 avec au moins 2 FranÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ais, 3 joueurs de Liga et collectif minimum 75.',
...
module.exports={init,handle,openStorePack,startSecureMatch,finishSecureMatch,cloudMarketSearch,cloudListOwnedItem,cloudBuyMarketListing,cloudTradePile,cloudTradePileCounts,cloudTradeStatus,cloudWatchList,cloudHubDocument,cloudRelistExpired,cloudClearMarketListing,relistExpiredListings,clearFinishedListings,squadDocument,squadList,hubDocument,creditsDocument,homeWalletDocument,homeRecordDocument,settingsDocument,pileSizeDocument,seasonListDocument,seasonUserDocument,seasonHistoryDocument,
  ...
  syncMngCloudWallet,queueMngCloudWalletSync,syncMngCloudClub,queueMngCloudClubSync,
