...
const RIBERY_SBC_RARE_FLAG = 24; // RibÃƒÂ©ry SBC rarity
const RIBERY_SBC_CARD = {assetId:156616,name:'Franck RibÃƒÂ©ry',rating:87,position:'LM',positionId:16,teamId:21,leagueId:19,nation:18,attributes:[85,79,85,91,28,61],quality:'gold',resourceId:RIBERY_SBC_RESOURCE_ID,definitionId:RIBERY_SBC_RESOURCE_ID,version:5,rareFlag:24,cardType:'sbc',cardTypeName:'SBC Reward'};
...
// player on the client (Effenberg -> EVANGELISTA, MatthÃƒÂ¤us -> BLACKMAN), and
...
const V38_REMOVED_ICON_ASSET_IDS = new Set([
  ...
  191190, // broken MatthÃƒÂ¤us slot -> Blackman
...
const V38_REMOVED_ICON_RESOURCE_IDS = new Set([
  ...
  16992775,16968406, // broken Effenberg / MatthÃƒÂ¤us resources
...
const RIBERY_SPECIAL_CARD = {
  assetId:156616,
  name:'Franck RibÃƒÂ©ry',
  displayName:'Franck RibÃƒÂ©ry', commonName:'RibÃƒÂ©ry', knownAs:'RibÃƒÂ©ry', firstName:'Franck', lastName:'RibÃƒÂ©ry', surname:'RibÃƒÂ©ry', shortName:'RibÃƒÂ©ry',
  rating:90,
  position:'LM',
  positionId:16,
  teamId:21,
...
const KAKA_SPECIAL_CARD = {
  assetId:138449,
  name:'KakÃƒÂ¡',
  displayName:'KakÃƒÂ¡', commonName:'KakÃƒÂ¡', knownAs:'KakÃƒÂ¡', firstName:'Ricardo', lastName:'KakÃƒÂ¡', surname:'KakÃƒÂ¡', shortName:'KakÃƒÂ¡',
  rating:89,
  position:'CAM',
  positionId:18,
  teamId:47,
...
const COMMUNITY_SBC_CARDS = [
  ...
  {setId:96006,challengeId:960061,assetId:150418,resourceId:100813714,name:'Mario GÃƒÂ³mez',shortName:'Gomez',rating:88,position:'ST',positionId:25,teamId:21,leagueId:19,nation:21,attributes:[83,90,73,82,43,83],skillMoves:3,weakFoot:4,requiredRating:84},
  ...
  {assetId:190049,resourceId:100853345,name:'EusÃƒÂ©bio',shortName:'EusÃƒÂ©bio',rating:91,position:'ST',positionId:25,teamId:ICON_CLUB_ID,leagueId:ICON_LEAGUE_ID,nation:38,attributes:[92,92,84,91,44,77],skillMoves:4,weakFoot:5,preferredFoot:'right',icon:true},
  ...
  {assetId:190048,resourceId:100853344,name:'Gerd MÃƒÂ¼ller',shortName:'MÃƒÂ¼ller',rating:92,position:'ST',positionId:25,teamId:ICON_CLUB_ID,leagueId:ICON_LEAGUE_ID,nation:21,attributes:[87,92,76,85,44,74],skillMoves:4,weakFoot:4,preferredFoot:'right',icon:true},
  {assetId:261593,resourceId:17038809,name:'JÃƒÂ¼rgen Kohler',shortName:'Kohler',rating:89,position:'CB',positionId:5,teamId:ICON_CLUB_ID,leagueId:ICON_LEAGUE_ID,nation:21,attributes:[71,51,63,62,91,90],skillMoves:2,weakFoot:3,preferredFoot:'right',icon:true},
...
const DANI_ALVES_SBC_REQUIREMENTS = [
  {type:'NATION_COUNT',scope:'SQUAD',nationId:54,min:2,value:2,name:'Joueurs brÃƒÂ©siliens : minimum 2'},
  ...
  {type:'TEAM_RATING',scope:'SQUAD',min:83,value:83,name:'Note ÃƒÂ©quipe : minimum 83'},
  {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:70,value:70,name:'Collectif : minimum 70'},
  {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,exact:true,name:"Nombre de joueurs dans l'ÃƒÂ©quipe : 11"}
];
...
const DRAFT_OPPONENT_TEAMS = [
  ...
  {teamId:21,teamName:'FC Bayern MÃƒÂ¼nchen',teamAbbr:'FCB'},
...
const PRESENTATION_ITEMS = [
  ...
  {id:1700000001,resourceId:6300005,assetId:14,teamid:21,teamId:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:2,displayName:'Bayern MÃƒÂ¼nchen Home',defaultActiveState:'activeHomeKit',itemState:'activeHomeKit'},
  {id:1700000002,resourceId:6400004,assetId:15,teamid:21,teamId:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:3,displayName:'Bayern MÃƒÂ¼nchen Away',defaultActiveState:'activeAwayKit',itemState:'activeAwayKit'},
  {id:1700000003,resourceId:6000004,assetId:21,teamid:21,teamId:21,cardassetid:39,cardsubtypeid:11,itemType:'custom',family:'badges',table:'fcc_badgecards',rating:87,rareflag:1,category:1,displayName:'Bayern MÃƒÂ¼nchen',defaultActiveState:'activeBadge',itemState:'activeBadge'},
...
function loadFifa17ManagerCatalogue() {
  ...
  try {
    ...
    return [
      {managerId:89,staffId:89,pictureId:89,cardDbId:1000089,assetId:1000089,resourceId:1000089,definitionId:1000089,headId:232298,headAssetId:232298,firstName:'ArsÃƒÂ¨ne',lastName:'Wenger',name:'ArsÃƒÂ¨ne Wenger',rating:86,value:86,rareflag:1,rareFlag:1,nation:18,teamid:1,teamId:1,leagueId:13,managerLeagueId:13,formationId:0,formationid:0,talkRating:0,negotiation:3,contractBoost:3,quality:'gold'},
      ...
      {managerId:414,staffId:414,pictureId:414,cardDbId:1000414,assetId:1000414,resourceId:1000414,definitionId:1000414,headId:232302,headAssetId:232302,firstName:'JÃƒÂ¼rgen',lastName:'Klopp',name:'JÃƒÂ¼rgen Klopp',rating:84,value:84,rareflag:1,rareFlag:1,nation:21,teamid:9,teamId:9,leagueId:13,managerLeagueId:13,formationId:0,formationid:0,talkRating:0,negotiation:3,contractBoost:3,quality:'gold'},
...
const CLUB_ITEM_CARDS = [
  {resourceId:6300005,assetId:14,teamid:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:2,displayName:'Bayern MÃƒÂ¼nchen Home',defaultActiveState:'activeHomeKit'},
  {resourceId:6400004,assetId:15,teamid:21,cardassetid:35,cardsubtypeid:9,itemType:'kit',family:'kits',table:'fcc_kitcards',rating:87,rareflag:1,category:3,displayName:'Bayern MÃƒÂ¼nchen Away',defaultActiveState:'activeAwayKit'},
  {resourceId:6000004,assetId:21,teamid:21,cardassetid:39,cardsubtypeid:11,itemType:'custom',family:'badges',table:'fcc_badgecards',rating:87,rareflag:1,category:1,displayName:'Bayern MÃƒÂ¼nchen',defaultActiveState:'activeBadge'},
...
function loadCatalog() {
  if (!catalog) {
    ...
    if(!catalog.specials.some(card=>Number(card.resourceId)===RIBERY_SBC_RESOURCE_ID))catalog.specials.push({...RIBERY_SBC_CARD,displayName:RIBERY_SBC_CARD.name,commonName:'RibÃƒÂ©ry',knownAs:'RibÃƒÂ©ry',firstName:'Franck',lastName:'RibÃƒÂ©ry',surname:'RibÃƒÂ©ry'});
...
function saveSquad(body, routeId) {
  ...
  // Return a wire-only document if the client echoes one back instead of polluting Mes ÃƒÂ©quipes.
...
function rewardPackDocument(entry) {
  ...
  if(Number(entry.rewardResourceId)>0){
    ...
    const rewardName=`RÃƒÂ©compense SBC - ${playerName}`;
    return {
  ...
  if(packId===STARTER_TOTW_PACK_ID||packId===STARTER_OTW_PACK_ID){
    ...
    const rewardName=`Pack de dÃ©part ${cardType}`;
    const rewardDescription=`Contient exactement 1 joueur de raretÃ© ${cardType}.`;
    return {
      id:Number(entry.id),purchasedPackId:Number(entry.id),packId,
  ...
  if(PACKS[packId]){
    ...
    return {
      ...
      name:pack.name,nameLoc:pack.name,description:`RÃƒÂ©compense : ${pack.name}`,descriptionLoc:`RÃƒÂ©compense : ${pack.name}`,
...
const MNG_SBC_PLAYER_PACK_META_V17 = new Map([
  ...
  [295002,{name:'Philipp Lahm [Loan]', description:'Joueur garanti : Philipp Lahm en prÃƒÂªt 10 matchs.'}],
  [296001,{name:'Franck RibÃƒÂ©ry',   description:'Joueur garanti : Franck RibÃƒÂ©ry.'}],
...
async function openRewardPack(instanceId) {
  ...
  if(index<0)return {status:404,error:'REWARD_PACK_NOT_FOUND',reason:'Aucun pack rÃƒÂ©compense disponible.'};
  ...
  if(Array.isArray(entry.cloudResourceIds)&&entry.cloudResourceIds.length){
    ...
    if(cards.length!==entry.cloudResourceIds.length)return {status:409,error:'CLOUD_SBC_REWARD_INVALID',reason:'RÃ©compense DCE cloud introuvable.'};
  ...
  if(Number(entry.rewardResourceId)>0){
    ...
    if(!card)return {status:409,error:'SBC_PLAYER_REWARD_NOT_FOUND',reason:'Carte de rÃƒÂ©compense SBC introuvable.'};
    const item=makePlayerItem(card,state,PILE_PURCHASED,true);
    const loanGames=Math.max(0,Number(entry.loanGames)||0);
    if(loanGames>0){
...
function auroraSbcElgReq(requirements) {
  ...
  for(const req of requirements||[]){
    ...
    if(type==='PLAYER_COUNT'){
      // Le nombre total de joueurs est portÃƒÂ© par challenge.numPlayers/squadSize.
      // Ne jamais crÃƒÂ©er un slot elgReq key=2 isolÃƒÂ©.
      continue;
    }
...
function offlineSeasonOpponentDocument(teamId,gameIndex=0) {
  ...
  const teamName=primaryPool[0]?.teamName||primaryPool[0]?.clubName||`Ãƒâ€°quipe IA ${teamId}`;
  return {
...
const OFFLINE_TOURNAMENT_DEFS = [
  {id:1,name:'Coupe Bronze hors ligne',description:'Remportez quatre matchs ÃƒÂ  ÃƒÂ©limination directe.',prize:500,trophyResourceId:1500,rounds:[[1,150],[1,200],[2,300],[2,500]]},
  {id:2,name:'Coupe Argent hors ligne',description:'Une coupe relevÃƒÂ©e rÃƒÂ©servÃƒÂ©e au mode solo.',prize:750,trophyResourceId:1501,rounds:[[1,175],[2,250],[2,375],[3,650]]},
  {id:3,name:'Coupe Or hors ligne',description:'Affrontez des ÃƒÂ©quipes fortes et gagnez la finale.',prize:1000,trophyResourceId:1502,rounds:[[2,225],[2,325],[3,500],[3,850]]},
...
// MNG DRAFT V7 - AURORA NATIVE WIRE
  ...
  const lahmLoanSet={
    ...
    description:'Echangez une equipe pour obtenir Lahm 95 en prÃƒÂªt 10 matchs.',repeatable:false,
  ...
  const riberySet={
    ...
    description:'Echangez une equipe pour obtenir Franck RibÃƒÂ©ry 90.',repeatable:false,
  ...
  const terryFinalPackAward={
    ...
    packAssetId:4,packAssetID:'4',name:'RÃƒÂ©compense SBC - John Terry',nameLoc:'RÃƒÂ©compense SBC - John Terry',
    localizedName:'RÃƒÂ©compense SBC - John Terry',packName:'RÃƒÂ©compense SBC - John Terry',packs:'RÃƒÂ©compense SBC - John Terry',packsAmount:1,
    AWD_PACKS_STRING:'RÃƒÂ©compense SBC - John Terry',AWD_PACKS_AMOUNT:1,AWD_PACKS_ASSET_IDS:'4',
...
if(['/ut/game/fifa17/sbs/sets','/ut/game/fifa17/sbc/sets','/sbs/sets'].includes(urlPath)&&method==='GET')return send(200,{
  ...
  const lahmLoanChallenge={
    ...
    description:'Obtenez Lahm 95 en prÃƒÂªt 10 matchs.',formation:'f442',formationId:0,
...
const lahmLoanSbcSquad={
  ...
  const riberyChallengeDefs=[
    {challengeId:960011,id:960011,setId:96001,name:'FC Bayern MÃƒÂ¼nchen',description:'Ãƒâ€°changez une ÃƒÂ©quipe avec des joueurs du Bayern.',formation:'f442',formationId:0,packId:203,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'TEAM_COUNT',scope:'SQUAD',teamId:21,min:1,value:1,name:'Joueurs du Bayern : minimum 1'},
      {type:'TEAM_RATING',scope:'SQUAD',min:82,value:82,name:'Note ÃƒÂ©quipe : minimum 82'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:80,value:80,name:'Collectif : minimum 80'}]},
    {challengeId:960012,id:960012,setId:96001,name:'Les Bleus',description:'Ãƒâ€°changez une ÃƒÂ©quipe construite autour de joueurs franÃƒÂ§ais.',formation:'f433',formationId:0,packId:204,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'NATION_COUNT',scope:'SQUAD',nationId:18,min:2,value:2,name:'Joueurs franÃƒÂ§ais : minimum 2'},
      {type:'TEAM_RATING',scope:'SQUAD',min:83,value:83,name:'Note ÃƒÂ©quipe : minimum 83'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:85,value:85,name:'Collectif : minimum 85'}]},
    {challengeId:960013,id:960013,setId:96001,name:'Bundesliga',description:'Ãƒâ€°changez une ÃƒÂ©quipe de Bundesliga avec au moins une carte TOTW.',formation:'f4231',formationId:0,packId:303,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'LEAGUE_COUNT',scope:'SQUAD',leagueId:19,min:4,value:4,name:'Joueurs Bundesliga : minimum 4'},
      {type:'SPECIAL_COUNT',scope:'SQUAD',cardType:'totw',min:1,value:1,name:'Joueurs TOTW : minimum 1'},
      {type:'TEAM_RATING',scope:'SQUAD',min:84,value:84,name:'Note ÃƒÂ©quipe : minimum 84'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:80,value:80,name:'Collectif : minimum 80'}]},
    {challengeId:960014,id:960014,setId:96001,name:'Ãƒâ€°quipe 85',description:'Ãƒâ€°changez une ÃƒÂ©quipe trÃƒÂ¨s bien notÃƒÂ©e avec un joueur TOTW pour terminer le dÃƒÂ©fi RibÃƒÂ©ry.',formation:'f41212',formationId:0,packId:304,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'SPECIAL_COUNT',scope:'SQUAD',cardType:'totw',min:1,value:1,name:'Joueurs TOTW : minimum 1'},
      {type:'TEAM_RATING',scope:'SQUAD',min:85,value:85,name:'Note ÃƒÂ©quipe : minimum 85'},
  ...
  const riberyChallenges=riberyChallengeDefs.map(def=>{
    ...
    const packAward={type:'pack',value:def.packId,halId:0,count:1,assetId:3,packId:def.packId,name:PACKS[def.packId]?.name||'Pack rÃƒÂ©compense'};
  ...
  if(match){
    ...
    if(method==='PUT'){
      ...
      if(allDone&&!state.sbcRiberyCompleted&&setCloudReward){
        finalRewardPack={id:Number(state.nextRewardPackId++),packId:296001,source:'SBC_RIBERY_FINAL',setId:96001,playerName:'Franck RibÃƒÂ©ry',rewardResourceId:RIBERY_SBC_RESOURCE_ID,cloudResourceIds:setCloudReward.resourceIds||[],cloudTransactionId:setCloudReward.transactionId};
  ...
  const terryChallengeDefs=[
    {challengeId:960111,id:960111,setId:96011,name:'Chelsea',description:'Ãƒâ€°changez une ÃƒÂ©quipe avec des joueurs de Chelsea.',formation:'f442',formationId:0,packId:304,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'TEAM_COUNT',scope:'SQUAD',teamId:5,min:2,value:2,name:'Joueurs de Chelsea : minimum 2'},
      {type:'TEAM_RATING',scope:'SQUAD',min:82,value:82,name:'Note ÃƒÂ©quipe : minimum 82'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:80,value:80,name:'Collectif : minimum 80'}]},
    {challengeId:960112,id:960112,setId:96011,name:'Three Lions',description:'Ãƒâ€°changez une ÃƒÂ©quipe construite autour de joueurs anglais.',formation:'f433',formationId:0,packId:305,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'NATION_COUNT',scope:'SQUAD',nationId:14,min:4,value:4,name:'Joueurs anglais : minimum 4'},
      {type:'TEAM_RATING',scope:'SQUAD',min:83,value:83,name:'Note ÃƒÂ©quipe : minimum 83'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:85,value:85,name:'Collectif : minimum 85'}]},
    {challengeId:960113,id:960113,setId:96011,name:'Premier League',description:'Ãƒâ€°changez une ÃƒÂ©quipe de Premier League avec au moins une carte TOTW.',formation:'f4231',formationId:0,packId:305,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
    ...
    {challengeId:960114,id:960114,setId:96011,name:'Ãƒâ€°quipe 85',description:'Ãƒâ€°changez une ÃƒÂ©quipe trÃƒÂ¨s bien notÃƒÂ©e pour terminer le Flashback de Terry.',formation:'f41212',formationId:0,packId:308,requirements:[
      {type:'PLAYER_COUNT',scope:'SQUAD',count:11,min:11,value:11,name:'Exactement 11 joueurs'},
      {type:'TEAM_RATING',scope:'SQUAD',min:85,value:85,name:'Note ÃƒÂ©quipe : minimum 85'},
      {type:'TEAM_CHEMISTRY',scope:'SQUAD',min:70,value:70,name:'Collectif : minimum 70'}]}
  ];
  ...
  if(match){
    ...
    if(method==='PUT'){
      ...
      if(finalRewardPack){
        ...
        response.groupCompleted=true;response.setCompleted=true;response.success=true;response.message='Groupe terminÃƒÂ© !';
  ...
  const communityChallengeDocuments=COMMUNITY_SBC_DEFS.map(def=>{
    ...
    const challengeAward={
      ...
      packId:challengePackId,name:challengePack?.name||'Pack rÃƒÂ©compense'
    };
    ...
    const challenge={
      ...
      description:'Ãƒâ€°quipe 83 avec 2 BrÃƒÂ©siliens, 3 joueurs de Serie A, 1 joueur TOTW et collectif minimum 70.',
  ...
  if(match){
    ...
    if(method==='PUT'){
      ...
      return send(200,{
        completed:true,isCompleted:true,groupCompleted:true,setCompleted:true,success:true,message:'Groupe terminÃƒÂ© !',
  ...
  const benYedderChallenge={
    ...
    description:'Ãƒâ€°quipe 82 avec au moins 2 FranÃƒÂ§ais, 3 joueurs de Liga et collectif minimum 75.',
