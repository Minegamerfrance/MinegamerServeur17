...
function Assert-MngLocalSenorClutch {
    ...
    # FIFA uses the same Windows resolver. Never launch it until the resolver
    # itself sees the hosts mapping, otherwise the game would be offline.
    ...
    throw "senorclutch.game ne se resout pas vers 127.0.0.1 apres activation du service DNS Windows. Detail: $lastResolverError"
}
