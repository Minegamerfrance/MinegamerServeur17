...
try {
    ...
    try {
        ...
        Add-Content -LiteralPath $friendPreflight -Value "MNG V56 resolver fallback: $($_.Exception.Message)"
    }
    $cfg=@"
[Login]
Host=$loginHost
...
"@
    ...
    Add-Content -LiteralPath $friendPreflight -Value "MNG V56 adaptive login host: $loginHost"
    Write-Host "MNG V56: hote de connexion -> $loginHost" -ForegroundColor Green
